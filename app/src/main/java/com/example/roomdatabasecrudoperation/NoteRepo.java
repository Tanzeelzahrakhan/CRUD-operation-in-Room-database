...
public class NoteRepo {
   ...
   void insertData(Note note){new InsertTask(noteDao).execute(note);}
   void updateData(Note note){new UpdateTask(noteDao).execute(note);}
   void deleteData(Note note){new DeleteTask(noteDao).execute(note);}
